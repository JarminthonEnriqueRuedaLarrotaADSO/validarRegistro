...
<body>
                                ...
                                <form action="index.php" method="post" class="row" id="formulario">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="habilidades[]" value="html" id="html" <?php if(in_array('html', $habilidades)) echo "checked" ?>>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="habilidades[]" value="sql" id="sql" <?php if(in_array('sql', $habilidades)) echo "checked" ?>>
    ...
    <!-- <script src="main.js" type="text/javascript"></script> --> //descomentar script para habilitar la validacion con JS
</body>
